...
// console.log('email in preview',email);
    ...
    return (
        <article className={`email-preview  ${(!email.isRead) && email.status==='inbox'? 'not-read' : 'mail-read'} 
        ...
        {/* <article className={`email-preview  ${email.isRead && 'bold'}`}> */}
            ...
            <div className="email-preview-div email-prev-message">  <LongTxt text={email.message} /></div>
